    ...
    <div class="authentication-inner py-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{route('pagar.book.forget.password.post')}}" method="POST" class="mb-3">
                    @csrf
                ...
                <div class="text-center">
                    <a href="{{route('pagar.book.login')}}" class="d-flex align-items-center justify-content-center">
