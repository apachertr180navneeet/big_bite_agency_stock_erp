    ...
    <body>
       <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                @include('pagar_book.layouts.elements.left_sidebar')
                <div class="layout-page">
                    @include('pagar_book.layouts.elements.header')
                    <div class="content-wrapper">
                        @yield('content')
                        <div class="content-backdrop fade"></div>
                        @include('pagar_book.layouts.elements.footer')
                    </div>
                    @include('pagar_book.layouts.elements.right_sidebar')
                </div>
                ...
                @yield('script')
                @include('pagar_book.layouts.elements.sweet_alerts')
            </div>
